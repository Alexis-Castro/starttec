...
<div class="relative overflow-x-auto shadow-lg sm:rounded-lg mb-8" id="listado-contactos">
         ...
         <tbody>
            <?php foreach ($contactos as $contacto) : ?>
               <tr class="border-b bg-gray-800 border-gray-700 hover:bg-gray-700">
                  ...
                  <td class="px-6 py-4 ">
                     <?php echo (new DateTime($contacto->created_at))->format('d/m/Y h:i')  ?>
                  </td>
