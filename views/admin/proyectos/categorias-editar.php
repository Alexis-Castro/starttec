<div class="fixed top-0 left-0 right-0 z-50 hidden w-full h-full justify-center items-center p-4 overflow-x-hidden overflow-y-auto outline-0 md:inset-0 max-h-full transition group ease-linear modal" id="modal-categoria-editar">
         ...
         <form class="" id="editar" method="POST">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
               <div class="p-6 col-span-2">
                  <label for="categoria_editar" class="block mb-2 text-gray-100 false">Categoría</label>
                  <input type="text" id="categoria_editar" class="rounded-lg border-transparent flex-1 appearance-none border w-full py-2.5 px-3 bg-gray-700 transition text-gray-300 placeholder-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-azul-claro focus:border-transparent" placeholder="Ingresar categoria" name="nombre">
