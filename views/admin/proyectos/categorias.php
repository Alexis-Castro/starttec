<div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-8">
   ...
   <div>
      <button class="btn btn-primary gap-1 js-modal-trigger" id="agregar-categoria" data-target="modal-categoria-crear">
...
<div class="relative overflow-x-auto shadow-lg sm:rounded-lg mb-8" id="listado-categorias">
               ...
               <tr class="border-b bg-gray-800 border-gray-700 hover:bg-gray-700">
                  ...
                  <td class="px-6 py-4">
                     <div class="flex items-center gap-x-3">
                        <button class="btn btn-primary gap-1 js-modal-trigger btn-editar" data-target="modal-categoria-editar" data-idcategoria="<?php echo $categoria->id ?>" title="Editar">
   ...
   <?php  } else { ?>
      <div class="shadow-xl p-14 bg-gray-800">
         <p class="text-2xl text-center overflow-hidden text-gray-200">No hay categorias registrados(a), empieza <span class="text-azul-claro">agregando</span> una(o).</p>
...
<!-- MODALES -->
<?php
require_once __DIR__ . '/categorias-crear.php';
?>
<?php
require_once __DIR__ . '/categorias-editar.php';
?>