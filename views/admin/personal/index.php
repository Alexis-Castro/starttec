<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
   ...
   <div>
      <a class="btn btn-primary gap-1" href="/admin/personal/crear">
...
<div class="relative overflow-x-auto shadow-lg sm:rounded-lg mb-8" id="listado">
         ...
         <tbody>
            <?php foreach ($personal as $persona) { ?>
               <tr class="border-b bg-gray-800 border-gray-700 hover:bg-gray-700">
                  ...
                  <td class="px-6 py-4">
                     <?php foreach ($cargos as $cargo) {  ?>
                        <?php echo ($persona->cargo_id === $cargo->id) ? $cargo->nombre : '' ?>
                     <?php } ?>
                  </td>
                  <td class="px-6 py-4">
                     <div class="flex items-center gap-x-3">
                        <a href="/admin/personal/editar?id=<?php echo $persona->id; ?>" class="btn btn-primary gap-1" title="Editar">
   ...
   <?php  } else { ?>
      <p class="text-2xl text-center overflow-hidden text-gray-200">No hay personal registrado, empieza <span class="text-azul-claro">agregando</span> una(o).</p>
   <?php } ?>
