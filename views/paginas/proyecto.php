<section class="h-screen relative z-10">
   <div class="w-full h-full absolute py-12 px-6 md:px-14 md:py-24 ">
      <div class="w-full h-full flex flex-col md:flex-row items-center justify-center gap-y-6 mx-auto lg:max-w-5xl xl:max-w-7xl">
         <div class="block basis-0 shrink z-10 md:grow relative p-2 text-gray-50">
            <span class="bg-azul text-white text-xs font-medium px-2.5 py-0.5 rounded-full ">Proyecto</span>
            <h1 class="font-bold text-4xl lg:text-6xl [text-wrap:balance] tracking-tight"> <?php echo $titulo ?> </h1>
         </div>
         <div class="basis-0 block shrink z-10 md:grow relative p-2 ">
            <a href="#" class="flex items-center justify-center bg-white shadow-2xl shadow-white w-20 h-20 rounded-full text-4xl text-white m-auto animate-sombras">
               <svg xmlns="http://www.w3.org/2000/svg" class="text-azul" width="33" height="33" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
   ...
   <div class="lg:max-w-6xl xl:max-w-7xl mx-auto w-full relative">
      <div class="lg:flex items-center justify-center">
         <div class="basis-0 block flex-grow flex-shrink p-2">
            <h2 class="text-4xl xl:text-5xl font-bold mb-5 after:line after:mr-auto"><?php echo $proyecto->nombre ?></h2>
            <div class="font-open prose max-w-none">
