<section class="h-screen relative z-10">
   <div class="w-full h-full absolute py-12 px-6 md:py-24 md:px-14 ">
      <div class="w-full h-full flex items-center justify-center mx-auto lg:max-w-5xl xl:max-w-7xl">
         <div class="block basis-0 shrink p-2 grow z-10 relative text-center md:flex-none md:w-2/3 text-gray-50">
            <!-- <p class="font-open mb-6">Servicios</p> -->
            <h2 class="font-bold text-4xl lg:text-6xl [text-wrap:balance] tracking-tight"> Sistemas Multiplataforma</h2>
            <p class="font-open text-lg mt-6 leading-8">Es la nueva forma de crear aplicaciones móviles y de escritorio, desarrollando una sola base de código y compartiéndolo en las diferentes plataformas existentes.</p>
            <div class="mt-10 flex justify-center gap-4">
               <a href="#inicio" id="conoce" class="btn btn-primary text-xl">
                  Obtener Cotización
               </a>
   ...
   <div class="overflow-hidden relative w-full h-full ">
      <div class="bg-[url(/build/img/fondo-sistemas-multi.webp)] absolute h-full bg-center bg-no-repeat bg-fixed bg-cover min-w-[calc(100%+50px)] max-w-none before:inset-0 before:absolute before:bg-[linear-gradient(0deg,rgba(0,0,0,.85),rgba(0,0,0,.8))]">
      </div>
   </div>
</section>
   ...
   <div class="lg:max-w-6xl xl:max-w-7xl mx-auto w-full relative">
      <div class="lg:flex items-center justify-center">
         <div class="basis-0 block flex-grow flex-shrink p-2 text-center">
            <h2 class="text-4xl xl:text-5xl font-bold mb-5 after:line after:mx-auto">¿Qué Ofrecemos?</h2>
         </div>
      </div>

      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 place-content-center my-6 gap-x-6 gap-y-8 xl:gap-x-4">
         <article class="relative flex flex-col items-center justify-center w-80 sm:w-full mx-auto p-2 transition duration-300 rounded-md shadow-lg hover:shadow-xl bg-white group">
            <div class=" w-full px-6 py-8 2xl:py-6 rounded transition text-center">
               <figure class="flex items-center justify-center">
                  <img class="object-cover w-14 h-14 transition duration-200 group-hover:scale-125" src="/build/img/android.svg" alt="Desarrollo de Apps Android">

               </figure>
               <h3 class="text-xl my-3">Desarrollo de Apps Android</h3>
               <p class="font-open">Contrata a desarrolladores de apps nativas para crear aplicaciones móviles Android de alta calidad.</p>
            </div>
         </article>
         <article class="relative flex flex-col items-center justify-center w-80 sm:w-full mx-auto p-2 transition duration-300 rounded-md shadow-lg hover:shadow-xl bg-white group">
            <div class=" w-full px-6 py-8 2xl:py-6 rounded transition text-center">
               <figure class="flex items-center justify-center">
                  <img class="object-cover w-14 h-14 transition duration-200 group-hover:scale-125" src="/build/img/pagina-web.svg" alt="Desarrollo de Sistemas Web">

               </figure>
               <h3 class="text-xl my-3">Desarrollo de Sistemas Web</h3>
               <p class="font-open">Desarrollamos sistemas que podrás utilizar desde la nube, desde cualquier parte del mundo</p>
            </div>
         </article>
         <article class="relative flex flex-col items-center justify-center w-80 sm:w-full mx-auto p-2 transition duration-300 rounded-md shadow-lg hover:shadow-xl bg-white group">
            <div class=" w-full px-6 py-8 2xl:py-6 rounded transition text-center">
               <figure class="flex items-center justify-center">
                  <img class="object-cover w-14 h-14 transition duration-200 group-hover:scale-125" src="/build/img/computadora.svg" alt="Desarrollo de Apps Escritorio">

               </figure>
               <h3 class="text-xl my-3">Desarrollo de Apps Escritorio</h3>
               <p class="font-open">Utilizamos las mejores tecnologías y herramientas para asegurar la máxima calidad y rendimiento.</p>
            </div>
         </article>
      </div>
   </div>
